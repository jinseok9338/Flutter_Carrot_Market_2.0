import 'package:carrot_market_2_0/models/message_data.dart';
...
Widget _delegate(context, index) {
  ...
  return _MessageTile(
    ...
    messageDate: date, // figure out the way to have date time
...
class _MessageTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.of(context).push(ChatDetail.route(messageData));
      },
      child: Container(
        height: 100,
